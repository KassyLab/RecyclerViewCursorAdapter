...
public class ContactDetailActivity extends AppCompatActivity {
	...
	private static final String EXTRA_ITEM_URI =
			ContactDetailActivity.class.getCanonicalName() + ".extras.ITEM_URI";
	
	public static Intent newIntent(Context context, Uri itemUri) {
			...
			getSupportFragmentManager().beginTransaction()
					.add(R.id.contact_detail_container,
							ContactDetailFragment.newInstance(
									(Uri) getIntent().getParcelableExtra(EXTRA_ITEM_URI)))
					.commit();
		}
	}
