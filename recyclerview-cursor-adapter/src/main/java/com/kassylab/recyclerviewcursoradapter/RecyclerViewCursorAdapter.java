...
package com.kassylab.recyclerviewcursoradapter;
...
public abstract class RecyclerViewCursorAdapter<ViewHolder extends RecyclerViewCursorAdapter.ViewHolder>
	...
	public Cursor swapCursor(Cursor newCursor) {
		...
		cursor = newCursor;
		rowIDColumn = (newCursor == null) ? -1 : newCursor.getColumnIndexOrThrow(BaseColumns._ID);
		...
		public ViewHolder(View view) {
			...
			itemView.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					onTouch(itemUri, getAdapterPosition());
				}
			});
		}
